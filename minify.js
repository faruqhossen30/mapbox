    ...
    })()(
        {
                    ...
                    (r.prototype = {
                        select: function (e, t) {
                            ...
                            if (
                                ...
                                (r.resultId = e.id),
                                (n !== this.lastSentIndex || r.queryString !== this.lastSentInput) && -1 != n && ((this.lastSentIndex = n), (this.lastSentInput = r.queryString), r.queryString))
                            )
                                return this.push(r);
                        },
                        start: function (e) {
                        ...
                        getRequestOptions: function (e) {
                            return Array.isArray(e) || (e = [e]), { method: "POST", host: this.origin, path: this.endpoint + "?access_token=" + this.access_token, headers: { "Content-Type": "application/json" }, body: JSON.stringify(e) };
                        },
                    ...
                    (r.prototype = {
                        ...
                        onAdd: function (e) {
                            if (
                                ...
                                this.setLanguage(),
                                this.options.localGeocoderOnly || (this.geocoderService = c(l({ accessToken: this.options.accessToken, origin: this.options.origin }))),
                            ...
                            return (
                                ...
                                t.appendChild(r),
                                (this._typeahead = new i(this._inputEl, [], { filter: !1, minLength: this.options.minLength, limit: this.options.limit })),
                        ...
                        createIcon: function (e, t) {
                            ...
                            if (
                                (n.setAttribute("class", "mapboxgl-ctrl-geocoder--icon mapboxgl-ctrl-geocoder--icon-" + e),
                        ...
                        _geocode: function (e) {
                            ...
                            var t,
                                n = ["bbox", "limit", "proximity", "countries", "types", "language", "reverseMode", "mode"],
                                r = this,
                                i = null,
                                o = n.reduce(function (e, t) {
                                    return (
                                        r.options[t] &&
                                            (["countries", "types", "language"].indexOf(t) > -1 ? (e[t] = r.options[t].split(/[\s,]+/)) : (e[t] = r.options[t]),
                                ...
                                t
                                    ...
                                    .then(
                                        function (t) {
                                            ...
                                            var n = {};
                                            return (
                                                t ? "200" == t.statusCode && ((n = t.body), (n.request = t.request), (n.headers = t.headers)) : (n = { type: "FeatureCollection", features: [] }),
                                                (n.config = o),
                                                ...
                                                this.options.externalGeocoder
                                                    ? ((l = this.options.externalGeocoder(e, n.features) || []),
                                                      l.then(
                                                          function (e) {
                                    ...
                                    .then(
                                        function (e) {
                                            ...
                                            this.options.filter && e.features.length && (e.features = e.features.filter(this.options.filter)),
                                                e.features.length
                                                    ? ((this._clearEl.style.display = "block"), this._eventEmitter.emit("results", e), this._typeahead.update(e.features))
                                    ...
                                    .catch(
                                        function (e) {
                                            (this._loadingEl.style.display = "none"),
                                                (u.length && this.options.localGeocoder) || (l.length && this.options.externalGeocoder)
                                                    ? ((this._clearEl.style.display = "block"), this._typeahead.update(u))
                                                    : ((this._clearEl.style.display = "none"), (this._typeahead.selected = null), this._renderError()),
                        ...
                        setOrigin: function (e) {
                            return (this.options.origin = e), (this.geocoderService = c(l({ accessToken: this.options.accessToken, origin: this.options.origin }))), this;
                        },
                        getOrigin: function () {
                            ...
                            if (this._map) {
                                ...
                                return (
                                    ...
                                    e.center
                                        ...
                                        : e.geometry && e.geometry.type && "Point" === e.geometry.type && e.geometry.coordinates && this.mapMarker.setLngLat(e.geometry.coordinates).addTo(this._map),
                                    this
                                );
                            }
                        },
                ...
                function (e, t, n) {
                    ...
                    function r(e) {
                        ...
                        return function (r) {
                            ...
                            for (var s = 0; s < r.length; s++) if ((o = i(n(s), r[s]))) return [s].concat(o);
                        };
                    }
                    function i(e, t) {
            ...
            17: [
                function (e, t, n) {
                    ...
                    (u.forwardGeocode = function (e) {
                        ...
                        var t = s(r({ country: e.countries }, o(e, ["proximity", "types", "autocomplete", "bbox", "limit", "language", "routing"])));
                        ...
                        (u.reverseGeocode = function (e) {
                            i.assertShape({
                                ...
                                (e.mode = e.mode || "mapbox.places");
                            var t = s(r({ country: e.countries }, o(e, ["country", "types", "bbox", "limit", "language", "reverseMode", "routing"])));
                            return this.client.createRequest({ method: "GET", path: "/geocoding/v5/:mode/:query.json", params: o(e, ["mode", "query"]), query: t });
                        }),
                        (t.exports = a(u));
                },
                        ...
                        !(function (i) {
                            ...
                            var l = function (e) {
                                ...
                                f = function (e) {
                                    ...
                                    return (
                                        2 == o
                                            ? ((t = e.charCodeAt(a) << 8), (n = e.charCodeAt(++a)), (i = t + n), (s += c.charAt(i >> 10) + c.charAt((i >> 4) & 63) + c.charAt((i << 2) & 63) + "="))
                                            : 1 == o && ((i = e.charCodeAt(a)), (s += c.charAt(i >> 2) + c.charAt((i << 4) & 63) + "==")),
                                        s
                                    );
                                },
            ...
            25: [
                function (e, t, n) {
                    ...
                    function o(e, t, n) {
                        if (t) e.call(n);
                        else for (var r = e.length, i = g(e, r), o = 0; o < r; ++o) i[o].call(n);
                    }
                    function s(e, t, n, r) {
                        if (t) e.call(n, r);
                        else for (var i = e.length, o = g(e, i), s = 0; s < i; ++s) o[s].call(n, r);
                    }
                    function a(e, t, n, r, i) {
                        if (t) e.call(n, r, i);
                        else for (var o = e.length, s = g(e, o), a = 0; a < o; ++a) s[a].call(n, r, i);
                    }
                    function u(e, t, n, r, i, o) {
                        if (t) e.call(n, r, i, o);
                        else for (var s = e.length, a = g(e, s), u = 0; u < s; ++u) a[u].call(n, r, i, o);
                    }
                    function l(e, t, n, r) {
                        if (t) e.apply(n, r);
                        else for (var i = e.length, o = g(e, i), s = 0; s < i; ++s) o[s].apply(n, r);
                    }
                    function c(e, t, n, r) {
                        var o, s, a;
                ...
                function (e, t, n) {
                    (function (e) {
                        function n(e, t, n) {
                            ...
                            function p() {
                                void 0 !== b && clearTimeout(b), (O = 0), (m = E = g = b = void 0);
                            }
                            function f() {
            ...
            32: [
                function (e, t, n) {
                    !(function (e, n, r) {
                        ...
                        function n(t) {
                            return (t = e(t)), { language: t[1] || o, extlang: t[2] || o, script: t[3] || o, region: t[4] || o };
                        }
                        function r(e, t, n) {
